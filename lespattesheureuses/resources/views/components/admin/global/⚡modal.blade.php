...
<div x-show="{{$modalName}}" @click.outside="{{$modalName}} = false" @keydown.escape.window="{{$modalName}} = false"
    ...
    <div class="absolute cursor-pointer top-2 right-2" @click="{{$modalName}} = false">
