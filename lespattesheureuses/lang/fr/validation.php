...
return [
    ...
    | par le validateur. Certaines règles ont plusieurs versions, comme les
    | règles de taille. N'hésitez pas à adapter chaque message ici.
    |
    */
    ...
    'ascii' => 'Le champ :attribute ne peut contenir que des caractères alphanumériques et symboles sur un octet.',
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez définir des messages de validation personnalisés pour des
    | attributs spécifiques en utilisant la convention "attribute.rule".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Ces lignes permettent de remplacer les noms des attributs par des
    | expressions plus lisibles, comme "Adresse e-mail" au lieu de "email".
    |
    */
